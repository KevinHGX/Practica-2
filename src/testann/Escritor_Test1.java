...
public class Escritor_Test1 extends Thread{
    ...
    public Escritor_Test1(String _name,Registros _registros,ArrayList<String> _stack,Semaphore _semaforo){
        super(_name);
    ...
    private void modificar(){
        ...
        for(int i = 0;i < iteracion; i++){
            ...
            //System.out.println("Hilo: "+getName()+" Ha escrito: "+(i+1));
        }
    }
